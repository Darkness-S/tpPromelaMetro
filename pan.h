...
#define _nstates1	4	/* :init: */
#define minseq1	12
#define maxseq1	14
#define _endstate1	3

#define _nstates0	13	/* Deplacement */
#define minseq0	0
#define maxseq0	11
...
#define PDeplacement	((P0 *)this)
typedef struct P0 { /* Deplacement */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, pprime) - 1*sizeof(short))
